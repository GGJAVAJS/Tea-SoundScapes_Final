  ...
  return (
    ...
    >
      {showImages && (
        ...
        <motion.img src="/dino_alto.png" alt="" className="absolute bottom-16 left-[20%] w-64 z-0" animate={{ y: [0, -10, 0] }} transition={{ duration: 6, repeat: Infinity, ease: "easeInOut", delay: 0.5 }} style={{ willChange: 'transform' }} />
        <motion.img src="/fantasia_dino.png" alt="" className="absolute bottom-28 right-[-10px] w-32 z-10" animate={{ y: [0, -15, 0] }} transition={{ duration: 7, repeat: Infinity, ease: "easeInOut", delay: 1 }} style={{ willChange: 'transform' }} />

        {/* Bottom Foliage */}
        <motion.img src="/arvore.png" alt="" className="absolute bottom-[-10px] left-[-30px] w-56 opacity-100 z-20" animate={{ rotate: [0, 2, 0] }} transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }} style={{ willChange: 'transform', transformOrigin: 'bottom center' }} />
        <motion.img src="/floresta.png" alt="" className="absolute bottom-[-20px] right-[-40px] w-72 opacity-100 z-20" animate={{ rotate: [0, -2, 0] }} transition={{ duration: 9, repeat: Infinity, ease: "easeInOut", delay: 1 }} style={{ willChange: 'transform', transformOrigin: 'bottom center' }} />
        <motion.img src="/palmeiras.png" alt="" className="absolute bottom-8 left-16 w-32 z-30" animate={{ rotate: [-2, 2, -2] }} transition={{ duration: 5, repeat: Infinity, ease: "easeInOut" }} style={{ willChange: 'transform', transformOrigin: 'bottom center' }} />
        <motion.img src="/palmeiras.png" alt="" className="absolute bottom-12 right-16 w-24 z-30" animate={{ rotate: [2, -2, 2] }} transition={{ duration: 6, repeat: Infinity, ease: "easeInOut", delay: 2 }} style={{ willChange: 'transform', transformOrigin: 'bottom center' }} />
      </div>
      )}
    </div>
  );
